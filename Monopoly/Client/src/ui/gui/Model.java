...
public class Model {
	...
	/**
	 * <ul> <li>THROWDICE: the player can throw the dice for the first time</li> <li>THROWDICEAGAIN: the player can throw
	...
	/**
	 * <ul> <li>PURCHASABLE: option to buy purchasable field</li> <li>BUYHOUSE: option to buy a house</li> <li>BUYHOTEL:
