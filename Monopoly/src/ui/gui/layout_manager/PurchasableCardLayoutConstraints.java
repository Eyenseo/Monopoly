...
/**
 * PurchasableCardLayoutConstraints provides information for the PurchasableCardLayout Probably it's not needed anymore
 */
public class PurchasableCardLayoutConstraints {
	...
	/**
	 * <ul> <li>STREET: The Component is a Street</li> <li>STATION: The Component is a Station</li> <li>FACILITY: The
	 * Component is a Facility</li> </ul>
	 */
